...
<template>
    ...
    <PageLinks>
        <template #links>
            ...
            <nuxt-link
                :to="`/horoscope/zodiac/planet/${currentRoute.title.en}/`"
                >Управляющая планета: {{ currentRoute.title.ru }}</nuxt-link
            >
        </template>
    </PageLinks>
    <description-block
        ...
        :description-type="'Управляющая планета'"
    ></description-block>
    <others-block
        :title="'Другие управляющие планеты'"
        :data="zodiacPlanet"
        :block-title="'Управляющая планета'"
        :navigate-to="'planet'"
    ></others-block>
</template>
