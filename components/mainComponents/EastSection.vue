...
.card:first-child {
    grid-area: first;
    background-image: url("@/assets/images/Oriental_horoscope_1.svg");
...
.card:last-child {
    ...
    position: relative;
    height: 704px;
    background-image: url("@/assets/images/Oriental_horoscope_3_chinese.svg");
    background-repeat: no-repeat;
...
@media (max-width: 1050px) {
    ...
    .card:last-child {
        ...
        position: relative;
        height: 704px;
        background-image: url("@/assets/images/Oriental_horoscope3_Zoroastrian_mob.svg");
        background-repeat: no-repeat;
        background-position: bottom left;
    }
